...
class PluginTreeblogs_ModuleTopic extends PluginTreeblogs_Inherit_ModuleTopic
{
     ...
     * @return array
     */
    public function GetForumTopicsByFilter($aFilter, $iPage = 0, $iPerPage = 0, $aAllowData = array('user' => array(), 'blog' => array('owner' => array()),
        'vote', 'favourite', 'comment_new')
    )
    {

        return $this->GetTopicsByFilter($this->_getModifiedFilterSubBlogs($aFilter), $iPage, $iPerPage, $aAllowData
        );
    }
...
*/
    ...
    protected function _getSubBlogs($iBlogId)
    {
		...
		$aBlogId = array_merge($aBlogId, $aSubBlogId['collection']);
